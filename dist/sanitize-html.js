...
(function (f) {
  ...
  return function () {
    ...
    30: [function (require, module, exports) {
      ...
      "entities/lib/decode_codepoint": 20,
      "entities/lib/maps/entities.json": 24,
      "entities/lib/maps/legacy.json": 25,
      "entities/lib/maps/xml.json": 26
    }],
    ...
    37: [function (require, module, exports) {
      ...
      var AtRule = /*#__PURE__*/function (_Container) {
        ...
        var _super2 = _createSuper(AtRule);
        ...
        function AtRule(defaults) {
          ...
          _this2 = _super2.call(this, defaults);
          _this2.type = 'atrule';
          return _this2;
        }
    ...
    38: [function (require, module, exports) {
      ...
      var Comment = /*#__PURE__*/function (_Node) {
        ...
        function Comment(defaults) {
          ...
          _this3 = _super3.call(this, defaults);
          _this3.type = 'comment';
          return _this3;
        }
    ...
    39: [function (require, module, exports) {
      ...
      function markDirtyUp(node) {
        ...
        if (node.proxyOf.nodes) {
          var _iterator3 = _createForOfIteratorHelper(node.proxyOf.nodes),
              _step3;
      ...
      var Container = /*#__PURE__*/function (_Node2) {
        _inherits(Container, _Node2);
            ...
            if (typeof nodes === 'string') {
              ...
              try {
                for (_iterator12.s(); !(_step12 = _iterator12.n()).done;) {
                  ...
                  if (_i3.parent) _i3.parent.removeChild(_i3, 'ignore');
                }
              } catch (err) {
                _iterator12.e(err);
              } finally {
                ...
                if (prop === 'proxyOf') {
                  ...
                  return function (cb) {
                    return node[prop](function (child) {
                      for (var _len6 = arguments.length, other = new Array(_len6 > 1 ? _len6 - 1 : 0), _key6 = 1; _key6 < _len6; _key6++) {
                        other[_key6 - 1] = arguments[_key6];
                      }
    ...
    40: [function (require, module, exports) {
      ...
      var CssSyntaxError = /*#__PURE__*/function (_Error) {
        ...
        var _super5 = _createSuper(CssSyntaxError);
        ...
        function CssSyntaxError(message, line, column, source, file, plugin) {
          ...
          _this5.name = 'CssSyntaxError';
          _this5.reason = message;
          ...
          if (Error.captureStackTrace) {
            Error.captureStackTrace(_assertThisInitialized(_this5), CssSyntaxError);
          }
        ...
        _createClass(CssSyntaxError, [{
          ...
          value: function showSourceCode(color) {
            ...
            return lines.slice(start, end).map(function (line, index) {
              ...
              if (number === _this6.line) {
                var spacing = aside(gutter.replace(/\d/g, ' ')) + line.slice(0, _this6.column - 1).replace(/[^\t]/g, ' ');
    ...
    41: [function (require, module, exports) {
      ...
      var Declaration = /*#__PURE__*/function (_Node3) {
        _inherits(Declaration, _Node3);

        var _super6 = _createSuper(Declaration);
        ...
        function Declaration(defaults) {
          ...
          _this7 = _super6.call(this, defaults);
          _this7.type = 'decl';
          return _this7;
        }
    ...
    42: [function (require, module, exports) {
      ...
      var Document = /*#__PURE__*/function (_Container2) {
        ...
        function Document(defaults) {
          ...
          _this8 = _super7.call(this, _objectSpread({
            type: 'document'
          }, defaults));
    ...
    43: [function (require, module, exports) {
      ...
      function fromJSON(json, inputs) {
        ...
        if (ownInputs) {
          ...
          var _iterator13 = _createForOfIteratorHelper(ownInputs),
              _step13;
          ...
          var LazyResult = /*#__PURE__*/function (_Symbol$toStringTag) {
            function LazyResult(processor, css, opts) {
              ...
              this.plugins = this.processor.plugins.map(function (plugin) {
                if (_typeof(plugin) === 'object' && plugin.prepare) {
                  return _objectSpread(_objectSpread({}, plugin), plugin.prepare(_this9.result));
                } else {
                  return plugin;
                }
              });
            ...
            _createClass(LazyResult, [{
                ...
                if (this.hasListener) {
                  ...
                  if (this.listeners.OnceExit) {
                    if (root.type === 'document') {
                      var _iterator15 = _createForOfIteratorHelper(root.nodes),
                          _step15;

                      try {
                        for (_iterator15.s(); !(_step15 = _iterator15.n()).done;) {
                          var subRoot = _step15.value;
                    ...
                    if (event === CHILDREN) {
                      if (node.nodes) {
                        node.each(function (child) {
                          if (!child[isClean]) _this10.walkSync(child);
                        });
                      }
                    } else {
              ...
              value: function visitSync(visitors, node) {
                var _iterator17 = _createForOfIteratorHelper(visitors),
                    _step17;

                try {
                  for (_iterator17.s(); !(_step17 = _iterator17.n()).done;) {
                    var _step17$value = _slicedToArray(_step17.value, 2),
                        plugin = _step17$value[0],
                        visitor = _step17$value[1];
                  ...
                  if (_typeof(plugin) === 'object' && plugin.Once) {
                    if (this.result.root.type === 'document') {
                      var roots = this.result.root.nodes.map(function (root) {
                        return plugin.Once(root, _this11.helpers);
                      });
              ...
              value: function () {
                var _runAsync = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
                  ...
                  var i, plugin, promise, root, stack, _promise, node, _iterator18, _step18, _loop;
                    ...
                    while (1) {
                      switch (_context2.prev = _context2.next) {
                        ...
                        case 39:
                          ...
                          _iterator18 = _createForOfIteratorHelper(this.listeners.OnceExit);
                          _context2.prev = 41;
                          _loop = /*#__PURE__*/regeneratorRuntime.mark(function _loop() {
                            var _step18$value, plugin, visitor, roots;

                            return regeneratorRuntime.wrap(function _loop$(_context) {
                              while (1) {
                                switch (_context.prev = _context.next) {
                                  case 0:
                                    _step18$value = _slicedToArray(_step18.value, 2), plugin = _step18$value[0], visitor = _step18$value[1];
                                    _this12.result.lastPlugin = plugin;
                                    _context.prev = 2;
                                    ...
                                    roots = root.nodes.map(function (subRoot) {
                                      return visitor(subRoot, _this12.helpers);
                                    });
                                    _context.next = 7;
                                    return Promise.all(roots);
                                  ...
                                  case 9:
                                    _context.next = 11;
                                    return visitor(root, _this12.helpers);
              ...
              value: function prepareVisitors() {
                ...
                var add = function add(plugin, type, cb) {
                  ...
                  _this13.listeners[type].push([plugin, cb]);
                };

                var _iterator19 = _createForOfIteratorHelper(this.plugins),
                    _step19;
    ...
    46: [function (require, module, exports) {
      ...
      var list = {
        split: function split(string, separators, last) {
          ...
          var _iterator20 = _createForOfIteratorHelper(string),
              _step20;

          try {
            for (_iterator20.s(); !(_step20 = _iterator20.n()).done;) {
              var letter = _step20.value;
          ...
          var MapGenerator = /*#__PURE__*/function () {
            ...
            _createClass(MapGenerator, [{
                ...
                if (!this.previousMaps) {
                  ...
                  this.root.walk(function (node) {
                    if (node.source && node.source.input.map) {
                      ...
                      if (!_this14.previousMaps.includes(map)) {
                        _this14.previousMaps.push(map);
                      }
                    }
                  });
                }
                ...
                this.root.walk(function (node) {
                  if (node.source) {
                    ...
                    if (from && !already[from]) {
                      ...
                      _this15.map.setSourceContent(_this15.toUrl(_this15.path(from)), node.source.input.css);
                    }
                  }
                });
              }
              ...
              value: function applyPrevMaps() {
                var _iterator21 = _createForOfIteratorHelper(this.previous()),
                    _step21;

                try {
                  for (_iterator21.s(); !(_step21 = _iterator21.n()).done;) {
                    var prev = _step21.value;
                ...
                this.stringify(this.root, function (str, node, type) {
                  ...
                  if (node && type !== 'end') {
                    ...
                    if (node.source && node.source.start) {
                      mapping.source = _this16.sourcePath(node);
                      mapping.original.line = node.source.start.line;
                      mapping.original.column = node.source.start.column - 1;

                      _this16.map.addMapping(mapping);
                    } else {
        ...
        function Node() {
          ...
          for (var name in defaults) {
            if (name === 'nodes') {
              ...
              var _iterator22 = _createForOfIteratorHelper(defaults[name]),
                  _step22;
      ...
      var Parser = /*#__PURE__*/function () {
        ...
        _createClass(Parser, [{
          ...
          value: function colon(tokens) {
            ...
            var _iterator23 = _createForOfIteratorHelper(tokens.entries()),
                _step23;
          ...
          var Processor = /*#__PURE__*/function () {
            ...
            _createClass(Processor, [{
              ...
              value: function normalize(plugins) {
                ...
                var _iterator24 = _createForOfIteratorHelper(plugins),
                    _step24;
    ...
    55: [function (require, module, exports) {
      ...
      var Root = /*#__PURE__*/function (_Container3) {
        _inherits(Root, _Container3);

        var _super8 = _createSuper(Root);
        ...
        function Root(defaults) {
          ...
          _this17 = _super8.call(this, defaults);
          _this17.type = 'root';
          if (!_this17.nodes) _this17.nodes = [];
          return _this17;
        }
    ...
    56: [function (require, module, exports) {
      ...
      var Rule = /*#__PURE__*/function (_Container4) {
        _inherits(Rule, _Container4);

        var _super9 = _createSuper(Rule);
        ...
        function Rule(defaults) {
          ...
          _this18 = _super9.call(this, defaults);
          _this18.type = 'rule';
          if (!_this18.nodes) _this18.nodes = [];
          return _this18;
        }
